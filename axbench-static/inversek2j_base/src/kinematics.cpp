...
float  __attribute((annotate("scalar(range(50,50) error(1e-8))"))) l1 = 50 ;
float  __attribute((annotate("scalar(range(50,50) error(1e-8))"))) l2 = 50 ;
...
*/
	float __attribute((annotate("scalar(range(2500, 20000) final)"))) sqtmp = (x * x + y * y);
