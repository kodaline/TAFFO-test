...
float  __attribute((annotate("range(50,50) scalar(error(1e-8))"))) l1 = 50 ;
float  __attribute((annotate("range(50,50) scalar(error(1e-8))"))) l2 = 50 ;
...
*/
	float __attribute((annotate("scalar(range(5000, 20000) final)"))) sqtmp = (x * x + y * y);
