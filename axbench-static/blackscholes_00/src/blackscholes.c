...
int    * otype;
fptype __attribute((annotate("scalar(range(0.35,0.84) error(1e-8))"))) *sptprice; // range(0.35,0.84)
fptype __attribute((annotate("scalar(range(0.33,0.92) error(1e-8))"))) *strike; // range(0.34,0.92)
fptype __attribute((annotate("scalar(range(0.0275,0.1) error(0))"))) *rate;
fptype __attribute((annotate("scalar(range(0.05,0.1) error(1e-8))"))) *volatility;
fptype __attribute((annotate("scalar(range(0.05,0.05) error(0))"))) *otime; // range(0.05,1)
int numError = 0;
